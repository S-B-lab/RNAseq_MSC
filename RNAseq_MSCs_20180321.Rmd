...
* **Heatmap analysis reveals 7 clusters separating MSC[in vitro] from MSC[SCI] and MSC[Naive]. 700 genes in cluster 2 explain most of the difference between MSC[SCI] and MSC[naive]**
...
**Fig 7.** _Figure reports the three-dimensional representation of 1000 bootstrap replicates of PCA. Left figure reports with three-dimensional coordinates while right figure does not._
...
grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(MDS_classical_fit, "Multidimensional Scaling\n[classical]"), left=textGrob("A", vjust=-9, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(MDS_nonmetric_fit, "Multidimensional scaling\n[nonmetric]"), left=textGrob("B", vjust=-9, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), dimension_legend, nrow=2, heights=c(5,1))

grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(sammon_mapping_plot_data, "Sammon's Non-\nLinear Mapping"), left=textGrob("C", vjust=-9, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(kpca_plot_data, "kernel\nPCA", textboolean = T), left=textGrob("D", vjust=-9, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), dimension_legend, nrow=2, heights=c(5,1))

grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(svd_plot_data, "Singular Value\nDecomposition", textboolean = T), left=textGrob("E", vjust=-9, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(MLFA_plot_data, "Maximum Likelihood\nFactor Analysis", textboolean = T), left=textGrob("F", vjust=-9, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), dimension_legend, nrow=2, heights=c(5,1))

```

**Fig 8.** _Figure 8A-F reports common dimensionality reduction algorithms applied on the dataset._
...
arrangeGrob(grob(myplclust(DT_hclust, labels=paste(DT_meta_data[,group]," ","(", DT_meta_data[,ID],")", sep=""), main="", ylab="", lab.col=brewer.pal(11, "RdBu")[c(1,2,10)][as.numeric(DT_meta_data[,group])], font=2, cex=1, hang=0.05)), left=textGrob("A", vjust=-9, hjust=0, gp=gpar(fontface=2, fontsize=20))),
...
#K-Nearest Neighbour
grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(PCA_cluster_data, "K-Nearest Neighbour\n(train:test-60:40)\n[PCA]", cluster_type = "KNN"), left=textGrob("A", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(tSNE_cluster_data, "K-Nearest Neighbour\n(train:test-60:40)\n[tSNE]", cluster_type = "KNN"), left=textGrob("B", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), cluster_legend, nrow=2, heights=c(5,1))
#Support Vector Machine
grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(PCA_cluster_data, "Support Vector Machine\n(train:test-60:40)\n[PCA]", cluster_type = "SVM"), left=textGrob("C", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(tSNE_cluster_data, "Support Vector Machine \n(train:test-60:40)\n[tSNE]", cluster_type = "SVM"), left=textGrob("D", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), cluster_legend, nrow=2, heights=c(5,1))
#K-Means Clustering
grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(PCA_cluster_data, "K-Means Clustering (3Cs)\n[PCA]", cluster_type = "KM"), left=textGrob("E", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(tSNE_cluster_data, "K-Means Clustering (3Cs)\n[tSNE]", cluster_type = "KM"), left=textGrob("F", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), cluster_legend, nrow=2, heights=c(5,1))
#Expectation Maximum
grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(PCA_cluster_data, "Expectation Maximum\n[PCA]", cluster_type = "EM"), left=textGrob("G", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(tSNE_cluster_data, "Expectation Maximum\n[tSNE]", cluster_type = "EM"), left=textGrob("H", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), cluster_legend, nrow=2, heights=c(5,1))
#Spectral Clustering
grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(PCA_cluster_data, "Spectral Clustering (3Cs)\n[PCA]", cluster_type = "SC"), left=textGrob("I", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(tSNE_cluster_data, "Spectral Clustering(3Cs)\n[tSNE]", cluster_type = "SC"), left=textGrob("J", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), cluster_legend, nrow=2, heights=c(5,1))
#Affinity Propagation
grid.arrange(arrangeGrob(arrangeGrob(dimension_plot_function(PCA_cluster_data, "Affinity Propagation\n[PCA]", cluster_type = "AP"), left=textGrob("K", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), arrangeGrob(dimension_plot_function(tSNE_cluster_data, "Affinity Propagation\n[tSNE]", cluster_type = "AP"), left=textGrob("L", vjust=-12, hjust=-3, gp=gpar(fontface=2, fontsize=20))), ncol=2), cluster_legend, nrow=2, heights=c(5,1))
...
**Fig 11. Clustering of 200 random bootstrap replicates for each sample using affinity propagation and L-means clustering** 
...
**Fig 11.** _Figure reports three-dimensional representations of clustering using affinity propagation and K-means clustering of 200 random bootstrap replicates of PCA per sample._
...
```{r echo=F, warning=F, message=F, error=F, fig.height=6, fig.width=14}
grid.arrange(arrangeGrob(DT_loadings_plot_function(DT_loadings_plotdata, "PC1"), left=textGrob("A", vjust=-11, hjust=1.5, gp=gpar(fontsize=20, fontface=2))), arrangeGrob(DT_loadings_plot_function(DT_loadings_plotdata,"PC2"), left=textGrob("B", vjust=-11, hjust=0, gp=gpar(fontsize=20, fontface=2))), ncol=2, left=textGrob("Gene", gp=gpar(fontface="bold", fontsize=17), rot=90))
...
**Fig 15.** _Figure reports the mean-variance relationship pre -and post application of the voom function. Fig 15A reports the average log-CPM against the quarter root of the variance. Fig 15B reports average log-CPM against the log2(st.dev). Blue line reports the average log2(st.dev). The red line is a linear trend fitted to the black dots. Each black dot represents a gene. Fig 15A illustrates that the variance is decresing when the average expression is increasing. In Fig 15B the dependency is removed and the mean variance is unchanged when the average expression increases._      
...
###SECTION OUTPUT
plot_grid(arrangeGrob(mean_difference_plot, left=textGrob("A", vjust=-15, hjust=-2, gp=gpar(fontsize=20, fontface=2))), arrangeGrob(volcano_plot, left=textGrob("B", vjust=-15, hjust=-2, gp=gpar(fontsize=20, fontface=2))))
...
## *Agglomerative hierarchical clustering with heatmap*
...
###SECTION OUTPUT
heatmap_plot_function(DT_logFC_significant_lcpm[, 3:length(DT_logFC_significant_lcpm)], 0.5, DT_meta_data[,group], "both", DT_logFC_significant_lcpm[, as.character(ifelse(is.na(SYMBOL), ENSEMBL_ID, SYMBOL))])
...
```{r echo=F, warning=F, message=F, error=F, fig.width=5, fig.height=5, fig.align='center'}
