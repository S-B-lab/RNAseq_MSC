...
```{r echo=F, warning=F, message=F, error=F, fig.height=6, fig.width=10}
#Clustering biological replicates (PCA & tSNE method) -> grid.arrange one method for both dim.red.methods
PCA_cluster <- DT_principal_comp[,c(1:4, 24)]
tSNE_cluster <- tSNE_plot_data
...
###OUTPUT SECTION
PCA_cluster[, EM:=EM_cluster_function(DT_principal_comp[,2:4])]
